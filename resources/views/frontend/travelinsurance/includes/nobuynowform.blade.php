        ...
        <div class="row" style="flex-wrap: nowrap;padding:0px">
            <div class="col-md-6 buynodropdownsectioncolsix">
                ...
                <p>
                    ...
                    I give permission to visitorguard.ca to transfer my quote information and contact details to {{ $second_comp_name }} in order to complete the purchase of travel insurance. Visitor Guard values your privacy. For details, see our 
