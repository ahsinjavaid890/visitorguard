                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div style="display: flex;position: relative;">
                                    ...
                                    <label style="margin-left: 18px;" for="applycheckbox<?php echo $newdeductibleforshow.$plan_id;?>"> I give permission to visitorguard.ca to transfer my quote information and contact details to <?php echo $comp_name;?> in order to complete the purchase of travel insurance. Visitor Guard values your privacy. For details, see our <a target="_blank" href="{{ url('privacypolicy') }}">Privacy Policy</a> </label>
                                </div>
