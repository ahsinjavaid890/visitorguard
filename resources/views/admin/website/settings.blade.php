        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 offset-md-2 offset-lg-2">
                    ...
                    // die();
                    ?>
                            <form action="{{ url('admin/website/settingsupdate') }}" enctype='multipart/form-data'
                                method="POST">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="website_name" class="form-control"
                                            placeholder="Website Name" value="{{$settings->site_name}}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="site_phonenumber" class="form-control"
                                            value="{{$settings->site_phonenumber}}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/website/updatelogos') }}" enctype='multipart/form-data'
                                method="POST">
                                @csrf
                                <div class="form-group row">
