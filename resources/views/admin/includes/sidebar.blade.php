            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ url('admin/sales/allsale') }}" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">All Sales
                            @if (DB::table('sales')->where('newstatus', 'new')->where('website', 'visitorguard')->count() > 0)
                        <span style="margin-left: 10px;"
                            class="badge badge-danger">{{ DB::table('sales')->where('newstatus', 'new')->where('website', 'visitorguard')->count() }}</span>
                    @endif
                        </span>
                    </a>
                </li>
