...
Route::get('/whole-life-insurance', [SiteController::class, 'lifeinsurance']);
Route::get('/critical-illness-insurance', [SiteController::class, 'termlifeinsurance']);
Route::get('/life-term-insurance', [SiteController::class, 'health']);
